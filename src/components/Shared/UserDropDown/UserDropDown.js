...
const UserDropDown = ({ toggle, setToggle }) => {
    ...
    return (
        <div className={`absolute top-16 right-5 w-48 bg-white z-20 ${toggle ? 'h-52 overflow-hidden border border-gray-300' : 'p-0 h-0 overflow-hidden'} transition-all duration-200`}>

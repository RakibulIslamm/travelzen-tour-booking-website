import { CalendarIcon, CurrencyBangladeshiIcon, UserGroupIcon } from '@heroicons/react/outline';
import React from 'react';
import { Link } from 'react-router-dom';

const PackageItem = (props) => {
    const { img, title, duration, cost, overview, group_size, _id } = props.packageItem
    return (
        <div>
